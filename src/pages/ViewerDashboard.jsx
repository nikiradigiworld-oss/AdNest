          ...
          <div className={s.profileTab}>
            ...
            <div className={s.panel}>
              ...
              <div className={s.panelBody}>
                ...
                <div style={{fontSize:'.82rem',color:'rgba(255,255,255,.6)',marginBottom:'.75rem'}}>
                  Share link: <span style={{color:'#FFD700',wordBreak:'break-all'}}>anaar.fun/signup?ref={refCode}</span>
                </div>
                <div className={s.statsGrid} style={{gridTemplateColumns:'1fr 1fr 1fr',gap:'.5rem',marginBottom:0}}>
